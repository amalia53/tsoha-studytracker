...
CREATE TABLE studentcourses (id SERIAL PRIMARY KEY, student_id INTEGER REFERENCES students (id), course_id INTEGER REFERENCES courses (id), ongoing BOOLEAN DEFAULT TRUE, visible BOOLEAN DEFAULT TRUE	);
